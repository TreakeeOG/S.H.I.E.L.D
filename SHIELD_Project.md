...
|**Component**|**Qty**|   **Estimated**  **Total (₹)** |
|:---:|:---:|:---:|
|**Arduino Nano (with cable)**|1|250|
|**Stainless electrodes (bolts/rods)**|2|150|
|**Resistors (10 MΩ, 100 kΩ, 1 MΩ)**|Set|60|
|**Piezo buzzer (5 V active)**|1|50|
|**Red LED + resistor (330 Ω)**|1|20|
|**Breadboard + jumper wire kit**|1|140|
|**Battery pack (3.7 V cell)**|1|250|
|**Plastic enclosure (IP65 style)**|1|550|
|**Miscellaneous (cables, clamps, tray, spares)**|—|200|
